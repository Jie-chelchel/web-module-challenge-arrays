...
function is31Flavors(/*your code here*/array) {
    if (array.length === 31) {
        return true;
    } else {
        return false;
...
function addFlavor(/*your code here*/currentFlaver, newFlaver) {
    currentFlaver.unshift(newFlaver);
    return currentFlaver;
...
function removeLastFlavor(/*your code here*/array) {
    array.pop();
    /*your code here*/
    return array;
}
...
function getFlavorByIndex(/*your code here*/ array, num) {
    return array[num];
    /*your code here*/
}
...
function removeFlavorByName(/*your code here*/array, str) {
...
function filterByWord(/*your code here*/originalFlavors, specialFlavor) {
    let filteredArray = [];
    for (let i = 0; i < originalFlavors.length; i++) {
        if (originalFlavors[i].includes(specialFlavor)) {
...
function getAverageWordLength(/*code here*/ array) {
